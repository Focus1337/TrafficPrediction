...
def save_image_annotated(img_rgb, file_name, output):
    """
...
def perform_object_detection(model, file_name, save_annotated=False):
    """
    ...
    if save_annotated:
        save_image_annotated(img_rgb, file_name, output)
